...
plot "by_files.data" u ($0):($5/$2) w p pt 0 title "Typechecking time/ average typechecking time before"


#plot "by_files.data" u ($0):(($6)/$3):(($7)/$3) w yerrorbars pt 0 title "Typechecking time/ average typechecking time before"
